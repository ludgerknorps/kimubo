...
#define KIMUBO_H
	...
	// ####################################################################################
	/* 
	 * Abschnitt StateMachines
	 */
	 
	// Die ganze KIMUBO wird in StateMachines aufgebauat
	// Wir verwenden die Arduino-fsm Library.
	#include <Fsm.h>
	 ...
	 */
		...
		// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		// Abschnitte 1, 2, 4, 7 siehe SourceCode-File //
		...
		// 6. Die TastaturBelegung selbst = welche Taste ist wo?
			...
			static const char KEYB_keyScans[KEYB_ALL_ROWS][KEYB_ALL_COLS] = {
